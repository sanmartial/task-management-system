...
public class TaskController {
    ...
    public TaskResponseDto create(@RequestBody CreateTaskRequireDto requireDto, Authentication authentication, @PathVariable Long projectId) {
        System.out.println(requireDto);
        return taskService.create(requireDto, authentication, projectId);
    }

    @GetMapping("/{projectId}")
    public List<TaskResponseDto> getAllTask(@PathVariable Long projectId, Authentication authentication) {
